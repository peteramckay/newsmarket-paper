 ...
 <a href="#footnotes"><p>Footnotes</p></a>
  ...
  <p>This draft document represents an attempt at that goal via creation of a new and decentralized digital marketplace for news. It would consist of a series of "distributed apps" that utilize the Dispatch<a href="#f2"><sup>2<sup></a> blockchain and related technologies currently under development.</p>
...
<ul>
  ...
  <p>The above is a first-draft attempt at designing a simple but powerful marketplace for news, incorporating blockchain-based features where appropriate. It will undoubtedly be subject to further iteration from here, with an eye toward helping make news economically viable again, thus better able to serve the needs of free societies.</p>
  ...
  <p><sup id="f5">5</sup> See Dispatch co-founder and chief technology officer Zane Witherspoon's full documentation of the DAPoS algorithm at https://bit.ly/2wY4mBB (April 2018)</p>

  <p><sup id="f6">6</sup> Digiday's Ricardo Bilton covered some of the hurdles that have historically tripped up micropayments for news at https://bit.ly/2KGz7gt (April 2015)</p>

  <p><sup id="f7">7</sup> Data scientist and author Cathy O'Neil cites opacity as one of the three key defining characteristics of an algorithm that functions as a "weapon of math destruction." See her remarks to Time magazine at https://ti.me/2c5sS5s (August 2016)</p>
